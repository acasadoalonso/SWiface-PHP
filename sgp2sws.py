...
#                        
	...
	if config.PicPilots == 'FAI':
		...
		tr={"trackId": config.Initials+fl_date_time+":"+flarmid, "pilotName": pilotname,  "competitionId": compid, "country": country, "aircraft": model, "registration": registration, "3dModel": "ventus2", "ribbonColors":[color], "portraitUrl": SWSserver+"SWS/pic/"+compid+".jpg", "3dModelVariant": SWSserver+"SWS/pic/"+compid+".sponsor.jpg"}
